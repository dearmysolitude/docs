...
> 좀 더 포괄적인 개념인 모듈 간 데이터의 연계인 <**인터페이스**>에 대한 내용은 다음 문서를 참고할 것 [[시스템 인터페이스 개발 방법론|ComputerScience/인터페이스]]
## 다양한 웹 서비스들
...
최근 웹 서비스들에서 **가장 많이 사용하는 REST API**에 대한 내용은 다음을 살펴보자: [[TODO. REST]]
### GraphQL
